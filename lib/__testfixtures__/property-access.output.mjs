...
import { toString as Object_toString } from "std:global/Object";
const a = [1, 2, 3];
const l = a.length;
...
Reflect_apply(Object_toString, onABoolean, []);
const onABooleanLiteral = Reflect_apply(Object_toString, false, []);
